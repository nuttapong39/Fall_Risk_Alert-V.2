...
> 📘 **แนะนำ: ดูคู่มือฉบับภาพ (step-by-step + mockup หน้าจอ) ที่ [`docs/install-guide.html`](docs/install-guide.html)** — เปิดในเบราว์เซอร์ ใช้ flow ปัจจุบัน (ตัวช่วยตั้งค่า DB อัตโนมัติ + ติดตั้ง Task คลิกเดียว). เอกสารด้านล่างนี้เป็นฉบับข้อความอ้างอิง
