...
$data = [
    "messages" => [
        [
            "type" => "text",
            "text" => "แจ้งเตือนผู้ป่วยโรงพยาบาลเชียงกลาง (ทดสอบ)"
        ],
        [
            "type" => "flex",
            ...
            "contents" => [
                ...
                "body" => [
                    ...
                    "contents" => [
                        ...
                        makeTextBox("HN: " . $hn),
                        makeTextBox("VN: " . $vn),
                        makeTextBox("เลขบัตรประชาชน: " . $cid),
                        // makeTextBox("เพศ: " . $gender),
                        // makeTextBox("อายุ: " . $age),
                        // makeTextBox("ที่อยู่: " . $address),
                        makeTextBox("รหัสโรคหลัก: " . $pdx),
                        makeTextBox("รหัสโรค EN: " . $ic1),
                        makeTextBox("รหัสโรค TH: " . $ic2),
