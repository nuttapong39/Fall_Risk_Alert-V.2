...
:: ─────────────────────────────────────────────────────────────────────────────
::  run_scrub.bat
::  Task Scheduler launcher — Scrub Typhus Alert Worker (สครับไทฟัส)
::
::  Usage (จาก Task Scheduler หรือ command line):
::    run_scrub.bat                          — ส่ง 7 วันล่าสุด (default)
::    run_scrub.bat dryrun                   — ทดสอบ ไม่ส่งจริง
::    run_scrub.bat start 2025-06-01         — backfill ตั้งแต่วันที่ระบุ
::    run_scrub.bat start 2025-06-01 end 2025-12-31
::
::  Task Scheduler (ทุกวัน เวลา 08:00):
::    Program : C:\xampp\htdocs\Fall_Risk_Alert-main\run_scrub.bat
