...
$data = [
    "messages" => [
        [
            "type" => "text",
            "text" => "แจ้งเตือนผู้ป่วยโรงพยาบาลเชียงกลาง"
        ],
        [
            "type" => "flex",
            ...
            "contents" => [
                ...
                "body" => [
                    ...
                    "contents" => [
                        ...
                        makeTextBox("HN: " . $hn),
                        makeTextBox("AN: " . $an),
                        makeTextBox("วันที่ Admit: " . $regdate),
						makeTextBox("รหัสสิทธิ: " . $pttype),
                        // makeTextBox("สิทธิการรักษา: " . $pttname),
                        // makeTextBox("อายุ: " . $age),
                        // makeTextBox("ที่อยู่: " . $address),
                        [
                            "type" => "box",
                            "layout" => "vertical",
                            "margin" => "sm",
...
curl_setopt_array($curl, [
    ...
    CURLOPT_HTTPHEADER => [
        'client-key: 699ba91e5851aaa1c76a00eea3e3f953fa33ec4e',
        'secret-key: E4UNHRQHSFEQ3YWZQSDRQF4OPXZQ',
